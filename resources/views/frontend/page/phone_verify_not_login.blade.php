    ...
    <div class="wrapper">
        <div class="col-lg-12 col-md-12">
            <div class="phone-verify">
                ...
                <p class="m-auto text-center">Check your Phone. We have sent a 4-digit PIN in your phone <strong>{{$phone_no}}</strong>.</p>
                ...
                <div class="col-lg-12 text-center mt-1">
                    ...
                    @else
                    <a href="{{route('resend_code',$phone_no)}}" class="p-2 main-color">Resend Code</a>
                    @endif  
                </div>
            </div>
        </div>
