...
@section('title')
<title>View Orders - {{$settings->company_name}}</title>
@endsection
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <?php $orders = DB::table('orders')->orderBy('id', 'DESC')->get(); ?>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a target="_blank" href="{{route('cartoon_top_print',$order->id)}}" style="background: blue; color: #fff; padding: 5px 10px; text-decoration:none;">Top Print</a>
