...
@section('title')
<title>View Supports - {{$settings->company_name}}</title>
@endsection
@section('main_layouts')
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title"> View Supports </h3>
        <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Supports</a></li>
            <li class="breadcrumb-item active" aria-current="page">View Supports</li>
        </ol>
        </nav>
    </div>
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table" id="search_filter">
                        ...
                        <?php $users = DB::table('users')->where(['role_as'=>'Support'])->orderBy('id', 'DESC')->get(); ?>
