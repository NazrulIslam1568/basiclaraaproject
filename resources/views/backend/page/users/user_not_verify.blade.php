...
@section('title')
<title>Not Verify User - {{$settings->company_name}}</title>
@endsection
@section('main_layouts')
<div class="content-wrapper">
    <div class="page-header">
        <h3 class="page-title">Not Verify User</h3>
        <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="#">Not Verify</a></li>
            <li class="breadcrumb-item active" aria-current="page">View Not Verify</li>
        </ol>
        </nav>
    </div>
    <div class="row">
            ...
            <div class="card">
                ...
                <div class="table-responsive">
                    <table class="table" id="search_filter">
                        ...
                        <?php $users = DB::table('users')->where(['phone_verify'=>0])->orderBy('id', 'DESC')->get(); ?>
